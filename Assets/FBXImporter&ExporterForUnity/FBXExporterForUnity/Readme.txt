...
FBX Exporter for Unity β Version 2017/11/15
...
■対応Visual C++ランタイム
 ...
 Visual Studio 2017 の Microsoft Visual C++ 再頒布可能パッケージ (x86とx64) : https://www.visualstudio.com/ja/downloads/
...
　FBXファイルは、3ds Max 2017 / Maya 2017 / Softimage 2015 / MotionBuilder 2017 / StingrayとFBX Importer for Unityに対応しています。
　Maya用にAnimatorの出力をする場合は、「Apply Root Motion」のチェックを外してから出力するようにしてください。
　使用されたテクスチャは、「Textures」フォルダに、PNG形式に自動変換され出力されます。
　DCCToolsが2017より下位のバージョンで、FBX形式(2018.1.1)を読み込む場合は、「FBX Converter 2013.3」を使用して、古いバージョンのＦＢＸ形式にコンバートしてから読み込んで下さい。
...
Japanese: https://www.visualstudio.com/ja/downloads/
English: https://www.visualstudio.com/downloads/
...
This FBX file is compatible with: 3ds Max 2017, Maya 2017, Softimage 2015, MotionBuilder 2017, Stingray and FBX Importer for Unity.
...
If the DCCTools being used is prior to the 2017 version; in order to be able to open the FBX format file (2018.1.1), please convert it to an older version of the FBX format using “FBX Converter 2013.3”.
